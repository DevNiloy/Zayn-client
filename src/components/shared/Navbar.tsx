            ...
            {user ? (
              <DropdownMenu>
                ...
                <DropdownMenuContent className="bg-black border border-white/10 text-white mt-2">
                  <DropdownMenuItem onClick={() => navigate("/dashboard")} className="focus:bg-white/10 focus:text-white cursor-pointer">
                    Dashboard
                  </DropdownMenuItem>
              ...
              <button onClick={() => navigate("/login")} className="text-xs uppercase tracking-widest hover:text-white">
                Login
              </button>
            )}
          </div>
              ...
              <SheetContent side="right" className="bg-black text-white border-l border-white/10 w-[300px]">
                ...
                <div className="relative mb-8 group">
                   ...
                   <Input 
                    type="text"
                    placeholder="Search..."
                    className="w-full bg-white/5 border-white/10 rounded-lg pl-10 py-5 text-sm text-white focus-visible:ring-white/20"
                   />
                </div>
                ...
                <div className="mt-8 pt-8 border-t border-white/5 space-y-4">
                  <button className="flex items-center gap-3 text-sm text-neutral-400 hover:text-white">
                    <ShoppingBag size={18} />
                    Cart
                  </button>
