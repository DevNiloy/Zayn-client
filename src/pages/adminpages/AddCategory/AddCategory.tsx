...
const AddCategory = () => {
  ...
  const handleCreateSubCategory = async (e: React.FormEvent) => {
    ...
    if (!subCatName || !parentCatId)
      return Swal.fire("Error", "সব তথ্য পূরণ করুন", "warning");
    ...
    try {
      ...
      Swal.fire({
        icon: "success",
        title: "সাব-ক্যাটাগরি তৈরি হয়েছে",
        toast: true,
        position: "top-end",
        showConfirmButton: false,
        timer: 3000,
  ...
  const handleDelete = async (id: string, type: "main" | "sub") => {
    const result = await Swal.fire({
      ...
      text:
        type === "main"
          ? "এটি ডিলিট করলে এর সাব-ক্যাটাগরিগুলোও মুছে যাবে!"
          : "এটি স্থায়ীভাবে মুছে ফেলা হবে।",
      icon: "warning",
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-500 font-medium">
              Manage your products hierarchy effortlessly
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="xl:col-span-4 space-y-8">
          ...
          <section className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
            <h2 className="flex items-center gap-2 font-black text-gray-800 mb-6 uppercase text-sm tracking-widest">
              <PlusCircle size={18} className="text-[#1F5E3B]" /> Create
              Category
            </h2>
            <form onSubmit={handleCreateCategory} className="space-y-6">
              ...
              <div className="relative group overflow-hidden bg-gray-50 aspect-video rounded-2xl border-2 border-dashed border-gray-200 hover:border-[#1F5E3B] transition-all flex flex-col items-center justify-center">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleImageChange(e.target.files?.[0], "main")
                  }
                />
              </div>
              ...
              <button
                ...
                className="w-full bg-[#1F5E3B] text-white py-4 rounded-2xl font-black hover:shadow-xl hover:shadow-green-100 transition-all flex justify-center items-center gap-2"
              >
                {isCreatingCat ? (
          ...
          <section className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
            <h2 className="flex items-center gap-2 font-black text-gray-800 mb-6 uppercase text-sm tracking-widest">
              <FolderPlus size={18} className="text-[#1F5E3B]" /> Create
              Sub-Category
            </h2>
            <form onSubmit={handleCreateSubCategory} className="space-y-6">
              ...
              <button
                ...
                className="w-full bg-gray-900 text-white py-4 rounded-2xl font-black hover:bg-black transition-all flex justify-center items-center gap-2"
              >
                {isCreatingSub ? (
                  <Loader2 className="animate-spin" />
                ) : (
        ...
        <div className="xl:col-span-8 space-y-6">
          <div className="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 overflow-hidden">
            <div className="p-8 border-b border-gray-50 flex justify-between items-center bg-gray-50/50">
              ...
              {isFetching && (
                <Loader2 className="animate-spin text-[#1F5E3B]" size={20} />
              )}
            </div>
            ...
            <div className="divide-y divide-gray-100">
              ...
              {categoriesData?.data?.map((cat: any) => (
                <div
                  key={cat._id}
                  className="p-8 hover:bg-gray-50/50 transition-all group"
                >
                    ...
                    <div className="flex items-center gap-6">
                      ...
                      <div>
                        ...
                        <div className="flex gap-2 mt-1">
                          <span className="text-[10px] bg-[#1F5E3B]/10 text-[#1F5E3B] px-3 py-1 rounded-full font-black uppercase">
                            Main
                          </span>
                          <span className="text-[10px] bg-gray-100 text-gray-500 px-3 py-1 rounded-full font-black uppercase">
                            ID: {cat._id.slice(-6)}
                          </span>
                        </div>
                      </div>
                  ...
                  {cat.subcategories && cat.subcategories.length > 0 && (
                    <div className="ml-24 mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
                      {cat.subcategories.map((sub: any) => (
                        <div
                          key={sub._id}
                          className="flex items-center justify-between bg-white p-5 rounded-[1.5rem] border border-gray-100 shadow-sm hover:border-[#1F5E3B]/30 transition-all group/sub"
                        >
                          <div className="flex items-center gap-4">
